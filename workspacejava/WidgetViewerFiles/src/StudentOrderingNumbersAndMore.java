...
public class StudentOrderingNumbersAndMore {
    ...
    public static void main(String[] args) {
        ...
        wv.add(num1, 10, 50, 300, 20);
        wv.add(num2, 10, 70, 300, 20);
        wv.add(num3, 10, 90, 300, 20);
        ...
        wv.add(hiLabel, 10, 150, 300, 20);
        wv.add(midLabel, 10, 170, 300, 20);
        wv.add(loLabel, 10, 190, 300, 20);
        ...
        wv.add(midEqualsHiLabel, 10, 250, 300, 20);
        wv.add(loEqualsMidLabel, 10, 270, 300, 20);
    }
}
